...
//    cout<<existCore[46862]<<" "<<existCore[47489]<<endl;
    ...
    string orderF = graphfile + ".CTorder";
    ifstream IF(orderF);
...
void Graph::Compute_tree_label(bool ifParallel, bool ifOpt){
...
//function of computing the H2H label of peripheries: with the distance information between interface vertices
